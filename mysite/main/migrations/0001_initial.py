# Generated by Django 2.2.4 on 2019-09-17 05:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('restaurant_address', models.CharField(default=False, max_length=100)),
                ('description', models.CharField(max_length=100)),
                ('image', models.ImageField(blank=True, upload_to='pics')),
                ('dish_name', models.CharField(default=None, max_length=200)),
